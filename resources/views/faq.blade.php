...
<html lang="en">
	...
	<head>
		...
		<link href="assets/css/carddashboard.css" rel="stylesheet" type="text/css" />		
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				@include('layoutssiswa.sidebar_faq');
				@include('layoutssiswa.header_siswa');
				<!--end::Header-->
				<!--begin::Wrapper-->
			<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="row g-5 g-xl-10 mb-5">
						<div class="card shadow-sm">
							<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#kt_docs_card_collapsible">
								<h3 class="card-title">Apa manfaatnya bagi alumni untuk berpartisipasi dalam tracer study?</h3>
							...
							<div id="kt_docs_card_collapsible" class="collapse show">
								<div class="card-body">
									Berpartisipasi dalam tracer study memungkinkan alumni untuk memberikan umpan balik tentang pengalaman mereka setelah lulus dari SMK Muhammadiyah 2. Ini juga memberikan kesempatan untuk terhubung kembali dengan sekolah dan alumni lainnya serta memengaruhi pengembangan pendidikan di masa depan.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row g-5 g-xl-10 mb-5">
						<div class="card shadow-sm">
							<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#kt_docs_card_collapsible">
								<h3 class="card-title">Apa tujuan dari tracer study yang dilakukan oleh SMK Muhammadiyah 2?</h3>
								<div class="card-toolbar rotate-180">
									<i class="ki-duotone ki-down fs-1"></i>
								</div>
							</div>
							<div id="kt_docs_card_collapsible" class="collapse show">
								<div class="card-body">
									Tujuan dari tracer study adalah untuk melacak perkembangan karir dan kontribusi alumni setelah lulus dari SMK Muhammadiyah 2. Ini membantu sekolah dalam mengevaluasi efektivitas kurikulum dan program pendidikan serta memperkuat hubungan antara sekolah dengan alumni.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row g-5 g-xl-10 mb-5">
						<div class="card shadow-sm">
							<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#kt_docs_card_collapsible">
								<h3 class="card-title">Apa itu sistem informasi tracer study?</h3>
								<div class="card-toolbar rotate-180">
									<i class="ki-duotone ki-down fs-1"></i>
								</div>
							</div>
							<div id="kt_docs_card_collapsible" class="collapse show">
								<div class="card-body">
									Sistem informasi tracer study adalah platform yang digunakan oleh SMK Muhammadiyah 2 untuk melacak jejak alumni setelah mereka tamat bersekolah. Ini memungkinkan sekolah untuk mengumpulkan data tentang kesuksesan karir dan kontribusi alumni dalam masyarakat.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row g-5 g-xl-10 mb-5">
						<div class="card shadow-sm">
							<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#kt_docs_card_collapsible">
								<h3 class="card-title">Bagaimana sistem tracer study membantu dalam meningkatkan kualitas pendidikan di SMK Muhammadiyah 2?</h3>
								<div class="card-toolbar rotate-180">
									<i class="ki-duotone ki-down fs-1"></i>
								</div>
							</div>
							<div id="kt_docs_card_collapsible" class="collapse show">
								<div class="card-body">
									Sistem tracer study membantu sekolah dalam mengevaluasi efektivitas kurikulum dan program pendidikan dengan mengumpulkan umpan balik dari alumni. Ini memungkinkan sekolah untuk menyesuaikan program pendidikan mereka dengan kebutuhan industri dan meningkatkan kualitas pendidikan secara keseluruhan.
								</div>
							</div>
						</div>
					</div>
    ...
    <!--end:::Main-->
		...
		<script src="../src/js/widgets/tables/datatable_card.js"></script>

	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				@include('layoutssiswa.sidebar_profilealumni');
				<!--begin::Header-->
				<div id="kt_app_header" class="app-header">
					...
					<div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
						...
						<div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
							<div class="app-navbar-it
							em d-flex align-items-stretch flex-lg-grow-1">
								<!--begin::Search-->
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
					...
					<div class="card card-p-0 card-flush p-10">
						<div class="row">
							<div class="col">
								<h1 class="mb-15">{{ $user->username }}</h1>
								<div class="mb-15">
									<div class="title fs-5">Tanggal Lahir : 12 maret</div>
									<div class="title fs-5">Alamat : jl.Naga Sakti</div>
									<div class="title fs-5">No.Telepon : 0813656464684</div>
								</div>
								<a href="#" class="btn btn-secondary">Ubah Profil</a>
							</div>
							<div class="col">
								<img src="../src/media/avatars/300-2.jpg" alt=""></div>
						</div>			
					</div>

							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<div class="card card-p-0 card-flush p-10">
										...
										<div class="row mb-10">
											<div class="col">
												<label for="basic-url" class="form-label">Judul Acara</label>
												<div class="input-group mb-5">
													<input type="text" class="form-control" placeholder="Masukkan Judul" name="judul_acara"/>
												</div>
											</div>
											<div class="col">
											...
											<div class="col">
												...
												<div class="input-group mb-5" id="tanggal" data-td-target-input="nearest" data-td-target-toggle="nearest">
													<input type="text" class="form-control" data-td-target="#tanggal" name="tanggal"/>
											...
											<div class="col">
												...
												<div class="input-group mb-5">
													<input type="text" class="form-control" placeholder="Masukkan Lokasi" name="lokasi"/>
												</div>
											</div>
											<div class="row mb-10">
											<div class="col">
												<div class="form-floating mb-7">
													<select class="form-select form-select-solid" id="floatingSelect1" aria-label="Floating label select example" name="status">

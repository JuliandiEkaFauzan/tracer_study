	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				@include('layouts.sidebar_alumni');
				<!--begin::Wrapper-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<div class="card card-p-0 card-flush p-10">
										<div class="row mb-5">
											<div class="col">
												<h1>Form Tambah Alumni</h1>
											</div>
										</div>
										<form action="{{ route('talumni.store') }}" method="post">
											<div class="row mb-5">
												@csrf
											<div class="col">
												<div class="mb-3">
											...
											<div class="col">
												...
												<div class="input-group mb-5" id="tanggal" data-td-target-input="nearest" data-td-target-toggle="nearest">
													<input type="text" class="form-control" data-td-target="#tanggal" name="tanggal_lahir"/>
										...
										<div class="row mb-10">
											...
											<div class="col-4">
												<label for="basic-url" class="form-label">Tahun Angkatan</label>
												<div class="input-group mb-5">
													<input type="text" class="form-control" placeholder="Masukkan tahun angkatan" name="tahun_angkatan" />
												</div>
											</div>
										</div>	
										...
										<div class="row mb-10">
											...
											<div class="col-1 me-4">
												<a href="{{ route('talumni.index') }}" class="btn btn-secondary">Batal</a>
											</div>
										</div>	
										</form>
									</div>
